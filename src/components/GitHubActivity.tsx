...
export function GitHubActivity() {
  ...
  const barCount = data.sparkline.length

  return (
    <div className="grid gap-4 grid-cols-2 lg:grid-cols-4">
      {/* Row 1: Year activity sparkline — full width */}
      <div className="col-span-2 lg:col-span-4 flex flex-col gap-3 rounded-2xl border border-border bg-background p-5">
      ...
      {/* Row 2: Top languages — full width */}
      <div className="col-span-2 lg:col-span-4 flex flex-col gap-3 rounded-2xl border border-border bg-background p-5">
        <p className="text-xs font-medium uppercase tracking-wider text-muted">
          Top languages
        </p>
