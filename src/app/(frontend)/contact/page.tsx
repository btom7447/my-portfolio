...
export default async function ContactPage() {
  ...
  const social = settings.socialLinks as {
    github?: string
    linkedin?: string
    twitter?: string
    facebook?: string
  ...
  const cmsFaq = settings.faq as { question: string; answer: string; id?: string }[] | undefined
  const faq = cmsFaq && cmsFaq.length > 0 ? cmsFaq : defaultFaq
  ...
  const socialLinks = [
    ...
    social?.twitter && { label: 'Twitter', href: social.twitter, icon: 'twitter' },
  ...
  return (
    <GSAPProvider>
      ...
      <main className="pt-28 pb-20">
          ...
          <div className="grid gap-16 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-6 text-lg text-muted">
                ...
                the form or reach out directly through my socials.
              </p>
        ...
        {/* FAQ */}
        {faq.length > 0 && (
          <div className="mx-auto mt-24 mb-24 max-w-5xl px-6">
